...
from .database import get_tenant_session, FAQ, BusinessProfile
...
def get_answer(question: str, intent: str, tenant_id: str, language: str = "en") -> str:
    ...
    system_prompt = (
        ...
        "3. NO HALLUCINATIONS: If the FAQ Context below does not have the EXACT answer, you MUST NOT use your general LLM knowledge. You MUST NOT guess details like discounts, packs, or prices.\n"
        f"4. FALLBACK: For ANY question you cannot answer using the provided FAQ Context, you MUST respond with this exact phrase (translated into {lang_name}): 'I do apologize, but I do not have specific details on that right now. Please provide your Name, Phone Number, and Email address, and our support team will contact you shortly to provide the information you need.'\n"
